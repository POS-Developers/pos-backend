...
from .views import test_slack_error  # Import Slack test error function
...
urlpatterns = [
    ...
    path('data/', views.api_data, name='api_data'),  # API Data

    # ✅ Test endpoint for Slack error notifications
